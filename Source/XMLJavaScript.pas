...
//根据XML节点生成C/Cpp代码
function GenXMLToJavaScript(xdXML:TXMLDocument;Option:TGenOption):string;
...
begin
     ...
     Result    := '<script type="text/javascript">'#13
               +GenNodeToCode(xdXML.DocumentElement,Option)
               +#13'</script>';
end;
